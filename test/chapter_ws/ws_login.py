...
class OKEXWebsocket(object):
    ...
    def on_open(self):
        """on open """
        print("on open")
        key = "0b47eae9-a6cd-4310-b85d-af79e23aa6ec"
        passphrase = "1234567890"
        secret = "7E8394EDCADA53EBBFE5AA56F770E08D"
        timestamp = str(time.time())
        msg = timestamp + "GET" + "/users/self/verify"
        sign = hmac.new(secret.encode('utf-8'), msg.encode('utf-8'), digestmod=hashlib.sha256).digest()
        sign = base64.b64encode(sign).decode('utf-8')
        data = {"op": "login", "args":[key,passphrase,timestamp, sign]} # {"op": "subscribe", "args": ["swap/depth5:BTC-USD-SWAP"]}
        self.send_msg(data)
